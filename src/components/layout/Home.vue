<template>
  <!--:class="{hideSidebar:!state.sidebar.opened,hoverSideBar:state.sidebar.minOpen}"-->
  <div class="app-wrapper" >
    <!-- 左侧 -->
    <!--:class="{hover:!state.sidebar.minOpened,light:theme=='light'}"-->
    <div class="side-wrapper" >
      <!-- logo -->
      <div style="height:50px;" class="logo-box">
        <!--v-show="state.sidebar.opened"-->
      ...
      <!--:class="{hidden:!state.sidebar.opened}"-->
      ...
      <t-header>
        ...
        <div class="messageBox" slot='msg-icon'>
          <Row>
            ...
            <!--:class="{'active':state.searchState.show}"-->
            <div class="iconBox" @click="searchFilter" >
...
<script>
  import THeader from '@/components/layout/header/THeader.vue'
